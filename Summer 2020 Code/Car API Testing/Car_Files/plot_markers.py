# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 22:52:52 2020
...
# plot points 
# client.simPlotPoints(points = [Vector3r(x,y,0) for x, y in zip(np.linspace(0,-10,20), np.linspace(0,-20,20))], 
...
# client.simPlotLineStrip(points = [Vector3r(x,y,0) for x, y in zip(np.linspace(0,-10,10), np.linspace(0,-20,10))], color_rgba=[1.0, 0.0, 0.0, 1.0], thickness = 5, duration = 30.0, is_persistent = False)

# # plot line list. 0-1, 2-3, 4-5. Must be even. 
# client.simPlotLineList(points = [Vector3r(x,y,0) for x, y in zip(np.linspace(0,-10,10), np.linspace(0,-20,10))], color_rgba=[1.0, 0.0, 0.0, 1.0], thickness = 5, duration = 30.0, is_persistent = False)
